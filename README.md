...
| 目录 | 内容 | 说明 |
|------|------|------|
| **`/`** (根目录) | **TripMate Planner 代码** | 行前规划环节的完整 Demo，可直接运行体验 |
| **`/docs`** | **TripMate 产品设计** | TripMate 整体产品 PRD + 页面示意，展示全貌愿景； TripMate Planner PRD + 技术架构说明 |
...
> 📄 完整 PRD 见 [`docs/TripMate-main-PRD.md`](docs/TripMate-main-PRD.md)
> 🖥️ 交互示意 见 [`docs/TripMate-main-pages.html`](https://geraldhzy.github.io/TripMate/TripMate-main-pages.html)（浏览器直接打开）

---

## TripMate Planner Demo
...
- **渐进式行程规划** — 4 个阶段逐步推进：需求与约束确认 → 大交通&框架调研 → 每日行程填充 → 预算&行前准备总结
...
├── __tests__/              # Jest 测试
├── docs/                   # 设计文档
    ├── TripMate-main-PRD.md                # TripMate 主需求文档
    └── TripMate-main-pages.html            # TripMate 主 APP 示意图
    ├── TripMate-planner-ARCHITECTURE.md    # TripMate Planner 技术架构
    ├── TripMate-planner-demo.gif           # TripMate Planner demo 演示图
    └── TripMate-planner-PRD.md             # TripMate Planner 需求文档
