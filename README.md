...
> 📄 完整 PRD 见 [`TripMate/TripMate-PRD.md`](TripMate/TripMate-PRD.md)
> 🖥️ 交互 Demo 见 [`TripMate/TripMate-Demo.html`](TripMate/TripMate-Demo.html)（浏览器直接打开）
...
![demo](TripMate-planner-demo.gif)
